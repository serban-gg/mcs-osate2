...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>tinstance subtypes</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link org.osate.xtext.aadl2.mcs.mcs.impl.t_instance_subtypesImpl#isT_callseq <em>Tcallseq</em>}</li>
 *   <li>{@link org.osate.xtext.aadl2.mcs.mcs.impl.t_instance_subtypesImpl#isT_eeflow <em>Teeflow</em>}</li>
 *   <li>{@link org.osate.xtext.aadl2.mcs.mcs.impl.t_instance_subtypesImpl#isT_proto <em>Tproto</em>}</li>
 *   <li>{@link org.osate.xtext.aadl2.mcs.mcs.impl.t_instance_subtypesImpl#isT_mode <em>Tmode</em>}</li>
 ...
 * @generated
 */
public class t_instance_subtypesImpl extends MinimalEObjectImpl.Container implements t_instance_subtypes
{
  /**
   ...
   * @generated
   */
  protected t_instance_subtypesImpl()
  {
    super();
  }
  ...
  {
    return McsPackage.Literals.TINSTANCE_SUBTYPES;
  }
  ...
  public void setT_subc_st(boolean newT_subc_st)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, McsPackage.TINSTANCE_SUBTYPES__TSUBC_ST, oldT_subc_st, t_subc_st));
  }
  ...
  public void setT_sbcall(boolean newT_sbcall)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, McsPackage.TINSTANCE_SUBTYPES__TSBCALL, oldT_sbcall, t_sbcall));
  }
  ...
  public void setT_callseq(boolean newT_callseq)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, McsPackage.TINSTANCE_SUBTYPES__TCALLSEQ, oldT_callseq, t_callseq));
  }
  ...
  public void setT_eeflow(boolean newT_eeflow)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, McsPackage.TINSTANCE_SUBTYPES__TEEFLOW, oldT_eeflow, t_eeflow));
  }
  ...
  public void setT_proto(boolean newT_proto)
  {
    ...
    t_proto = newT_proto;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, McsPackage.TINSTANCE_SUBTYPES__TPROTO, oldT_proto, t_proto));
  }
  ...
  public void setT_mode(boolean newT_mode)
  {
    ...
    t_mode = newT_mode;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, McsPackage.TINSTANCE_SUBTYPES__TMODE, oldT_mode, t_mode));
  }
  ...
  public void setT_mod_trans(boolean newT_mod_trans)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, McsPackage.TINSTANCE_SUBTYPES__TMOD_TRANS, oldT_mod_trans, t_mod_trans));
  }
  ...
  public void setT_mode_trig(boolean newT_mode_trig)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, McsPackage.TINSTANCE_SUBTYPES__TMODE_TRIG, oldT_mode_trig, t_mode_trig));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case McsPackage.TINSTANCE_SUBTYPES__TSUBC_ST:
        return isT_subc_st();
      case McsPackage.TINSTANCE_SUBTYPES__TSBCALL:
        return isT_sbcall();
      case McsPackage.TINSTANCE_SUBTYPES__TCALLSEQ:
        return isT_callseq();
      case McsPackage.TINSTANCE_SUBTYPES__TEEFLOW:
        return isT_eeflow();
      case McsPackage.TINSTANCE_SUBTYPES__TPROTO:
        return isT_proto();
      case McsPackage.TINSTANCE_SUBTYPES__TMODE:
        return isT_mode();
      case McsPackage.TINSTANCE_SUBTYPES__TMOD_TRANS:
        return isT_mod_trans();
      case McsPackage.TINSTANCE_SUBTYPES__TMODE_TRIG:

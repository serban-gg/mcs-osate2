...
public class QuantifiedExprImpl extends ExprImpl implements QuantifiedExpr
{
  ...
  {
    return McsPackage.Literals.QUANTIFIED_EXPR;
  }
  ...
  public void setQuant(String newQuant)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, McsPackage.QUANTIFIED_EXPR__QUANT, oldQuant, quant));
  }
  ...
  public NotificationChain basicSetExpr(Expr newExpr, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, McsPackage.QUANTIFIED_EXPR__EXPR, oldExpr, newExpr);
  ...
  public void setExpr(Expr newExpr)
  {
    if (newExpr != expr)
    {
      ...
      if (expr != null)
        msgs = ((InternalEObject)expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - McsPackage.QUANTIFIED_EXPR__EXPR, null, msgs);
      if (newExpr != null)
        msgs = ((InternalEObject)newExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - McsPackage.QUANTIFIED_EXPR__EXPR, null, msgs);
      msgs = basicSetExpr(newExpr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, McsPackage.QUANTIFIED_EXPR__EXPR, newExpr, newExpr));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case McsPackage.QUANTIFIED_EXPR__QUANT:
        return getQuant();
      case McsPackage.QUANTIFIED_EXPR__ARGS:
        return getArgs();
      case McsPackage.QUANTIFIED_EXPR__EXPR:

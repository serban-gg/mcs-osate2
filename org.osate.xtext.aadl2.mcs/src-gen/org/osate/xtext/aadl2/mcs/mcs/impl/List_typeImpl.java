...
public class List_typeImpl extends Composite_typeImpl implements List_type
{
  ...
  public NotificationChain basicSetRoot_type(Type_expression newRoot_type, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, McsPackage.LIST_TYPE__ROOT_TYPE, oldRoot_type, newRoot_type);
  ...
  public void setRoot_type(Type_expression newRoot_type)
  {
    if (newRoot_type != root_type)
    {
      ...
      if (root_type != null)
        msgs = ((InternalEObject)root_type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - McsPackage.LIST_TYPE__ROOT_TYPE, null, msgs);
      if (newRoot_type != null)
        msgs = ((InternalEObject)newRoot_type).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - McsPackage.LIST_TYPE__ROOT_TYPE, null, msgs);
      msgs = basicSetRoot_type(newRoot_type, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, McsPackage.LIST_TYPE__ROOT_TYPE, newRoot_type, newRoot_type));
  }

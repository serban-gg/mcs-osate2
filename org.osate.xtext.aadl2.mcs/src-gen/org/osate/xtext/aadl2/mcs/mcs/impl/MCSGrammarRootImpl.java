...
public class MCSGrammarRootImpl extends MinimalEObjectImpl.Container implements MCSGrammarRoot
{
   ...
   * @generated
   */
  public NotificationChain basicSetFile(MCSFile newFile, NotificationChain msgs)
  {
    MCSFile oldFile = file;
    file = newFile;
    if (eNotificationRequired())
    {
   ...
   * @generated
   */
  public void setFile(MCSFile newFile)
  {
    if (newFile != file)
    {
      NotificationChain msgs = null;

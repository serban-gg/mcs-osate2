...
public class RefExprImpl extends ExprImpl implements RefExpr
{
  ...
  {
    return McsPackage.Literals.REF_EXPR;
  }
  ...
  public NotificationChain basicSetReference(RefTerm newReference, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, McsPackage.REF_EXPR__REFERENCE, oldReference, newReference);
  ...
  public void setReference(RefTerm newReference)
  {
    if (newReference != reference)
    {
      ...
      if (reference != null)
        msgs = ((InternalEObject)reference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - McsPackage.REF_EXPR__REFERENCE, null, msgs);
      if (newReference != null)
        msgs = ((InternalEObject)newReference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - McsPackage.REF_EXPR__REFERENCE, null, msgs);
      msgs = basicSetReference(newReference, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, McsPackage.REF_EXPR__REFERENCE, newReference, newReference));
  }

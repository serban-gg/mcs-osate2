 ...
 * <ul>
 *   <li>{@link org.osate.xtext.aadl2.mcs.mcs.impl.Constant_declarationImpl#isConst <em>Const</em>}</li>
 *   <li>{@link org.osate.xtext.aadl2.mcs.mcs.impl.Constant_declarationImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.osate.xtext.aadl2.mcs.mcs.impl.Constant_declarationImpl#getType <em>Type</em>}</li>
...
public class Constant_declarationImpl extends MinimalEObjectImpl.Container implements Constant_declaration
{
  ...
  public void setConst(boolean newConst)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, McsPackage.CONSTANT_DECLARATION__CONST, oldConst, const_));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, McsPackage.CONSTANT_DECLARATION__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetType(Type_expression newType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, McsPackage.CONSTANT_DECLARATION__TYPE, oldType, newType);
  ...
  public void setType(Type_expression newType)
  {
    if (newType != type)
    {
      ...
      if (type != null)
        msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - McsPackage.CONSTANT_DECLARATION__TYPE, null, msgs);
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - McsPackage.CONSTANT_DECLARATION__TYPE, null, msgs);
      msgs = basicSetType(newType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, McsPackage.CONSTANT_DECLARATION__TYPE, newType, newType));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case McsPackage.CONSTANT_DECLARATION__TYPE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case McsPackage.CONSTANT_DECLARATION__CONST:
        return isConst();
      case McsPackage.CONSTANT_DECLARATION__NAME:
        return getName();
      case McsPackage.CONSTANT_DECLARATION__TYPE:
        return getType();
      case McsPackage.CONSTANT_DECLARATION__LEFT_EXPR:
